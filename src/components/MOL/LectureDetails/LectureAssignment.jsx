...
const LectureAssignment = ({ id, isDarkMode, class_ID, isEdit, language }) => {
                    ...
                    >
                      ...
                      {isEdit && (
                        ...
                        >
                          ...
                          >
                            <span style={{ marginRight: 2 }}>{t("Marks")}:</span>
                            <TextField
                              type="number"
                              InputLabelProps={{
                          ...
                          <Box sx={{ display: "flex", gap: 1 }}>
                            ...
                            >
                              {assignment.is_assigned ? t("Assigned") : t("Assign")}
                            </Button>
                          </Box>
