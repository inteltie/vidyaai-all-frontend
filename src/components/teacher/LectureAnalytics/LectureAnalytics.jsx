...
const LectureAnalytics = ({ lectureId, lang }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await meetingAnalytics(lectureId, language);
  ...
  return (
    ...
    >
        ...
        <Box sx={{ mt: 3 }}>
          ...
          <Box sx={{ display: "flex", gap: 3, mt: 2 }}>
            ...
            >
              ...
              <Typography variant="body2">{t("Positive")}</Typography>
            </Box>
            <Box
            ...
            >
              ...
              <Typography variant="body2">{t("Neutral")}</Typography>
            </Box>
            <Box sx={{ textAlign: "center", color: theme.palette.info.main }}>
              ...
              <Typography variant="body2">{t("Negative")}</Typography>
            </Box>
          </Box>
      ...
      {analytics?.main_topics?.length > 0 && (
        <Typography variant="h6" color={primaryColor}>{t("Main Topics")}</Typography>
      )}
      {analytics?.main_topics?.length > 0 && (
