      ...
      >
        ...
        <Box>
          <Typography
            ...
            fontWeight={"bold"}
          >
            {t("Subject Completion")}
          </Typography>
          <Typography variant="subtitle1">
            <span style={{ color: COLORS[0] }}>●</span> {t("Completed")}:{" "}
            {completionData?.Completion_percentage}%{" "}(
            {completionData?.completion_count} {t("lectures")})
          </Typography>
          <Typography variant="body1">
            <span style={{ color: COLORS[1] }}>●</span> {t("Pending")}:{" "}
            {completionData?.pending_percentage}%{" "}(
            {completionData?.pending_count} {t("lectures")})
          </Typography>
        </Box>
      </CardContent>
    </Card>
