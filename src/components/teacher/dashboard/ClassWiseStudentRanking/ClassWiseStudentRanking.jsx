...
const ClassWiseStudentRanking = ({ selectedOptions }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Tab label={`${t("Active")} (${data.active_students = 6 || 0})`} />
        <Tab label={`${t("Inactive")} (${data.inactive_students = 6 || 0})`} />
      </Tabs>
            ...
            {getChartData()?.map((entry) => (
              ...
              >
                ...
                <Box>
                  ...
                  >
                    {t("Grade")}:{t(mapData[entry.name]?.grade)}
                  </Typography>
                  <Typography
                    variant="body2"
                    sx={{
...
export const StudentModal = ({
  ...
  const staticStudentData = [
    { id: 1, name: "Amit Sharma", grade: "A", marks: 95 },
    { id: 2, name: "Priya Verma", grade: "A", marks: 92 },
    { id: 3, name: "Rohan Mehta", grade: "B", marks: 85 },
    { id: 4, name: "Sneha Das", grade: "B", marks: 80 },
    { id: 5, name: "Vikram Singh", grade: "C", marks: 75 },
    { id: 6, name: "Meera Iyer", grade: "C", marks: 70 },
    { id: 7, name: "Anil Nair", grade: "D", marks: 60 },
    { id: 8, name: "Kavita Yadav", grade: "D", marks: 55 },
  ];
  ...
  const fetchStudentByGrade = async () => {
    ...
    try {
      ...
      setStudentData(staticStudentData.filter((s) => s.grade === selectedGrad));
    } catch (error) {
      console.error(error);
    } finally {
      setLoading(false);
