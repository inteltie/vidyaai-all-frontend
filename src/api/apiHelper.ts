...
export const deleteUpcomingLecture = async (lectureId) => {
  const apiInstance = new apiServices(axiosAPIInstance);
  return await apiInstance.deleteUpcomingLecture(lectureId);
};
...
export const meetingAnalytics = async (meetingId, language="hi") => {
  const apiInstance = new apiServices(axiosAPIInstance);
  return await apiInstance.meetingAnalytics(meetingId, language);
};
...
export const getTeacherAssignment = async (lecture_id="",student_id="",classname="",subject="",search="",student_name="",assignment_id="", page=1) => {
  const apiInstance = new apiServices(axiosAPIInstance);
  return await apiInstance.getTeacherAssignment(lecture_id,student_id,classname,subject,search,student_name,assignment_id,page);
};
...
export const createSession = async (formData) => {
  const apiInstance = new apiServices(axiosAPIInstance);
  return await apiInstance.createSession(formData);
};

export const getNewLectureAns = async (sessionID, data) => {
  const apiInstance = new apiServices(axiosAPIInstance);
